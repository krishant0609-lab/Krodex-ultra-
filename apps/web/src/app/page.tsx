    ...
    <nav className={styles.nav} data-scrolled={scrolled}>
      <div className={styles.navInner}>
        ...
        <div className={styles.navCtas}>
          ...
          <Button variant="primary" size="sm" href="/login?mode=signup">Get started free</Button>
        </div>
      </div>
    </nav>
  );
    ...
    <section className={styles.hero}>
      ...
      >
        ...
        <motion.div className={styles.heroCtas} variants={FADE_UP} transition={{ duration: 0.6, delay: 0.3 }}>
          <Button variant="primary" size="lg" href="/login?mode=signup">Start for free</Button>
          <Button variant="secondary" size="lg" href="/login">I have an account</Button>
        </motion.div>
    ...
    <section className={styles.cta}>
      ...
      >
        ...
        <div className={styles.ctaActions}>
          <Button variant="primary" size="lg" href="/login?mode=signup">Create free account</Button>
          <Button variant="ghost" size="lg" href="/login">Sign in instead</Button>
        </div>
      </motion.div>
    </section>
  );
